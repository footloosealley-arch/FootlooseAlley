...
const empty: EventCouponInput = { code: "", discount_percent: 10, expires_at: null, usage_limit: null, is_active: true };
...
export default function EventCouponsDialog({ open, eventItem, onOpenChange }: { open: boolean; eventItem: StudioEvent | null; onOpenChange: (open: boolean) => void }) {
  ...
  function startAdd() { setEditing(null); setForm({ ...empty }); setShowForm(true); setError(""); }
